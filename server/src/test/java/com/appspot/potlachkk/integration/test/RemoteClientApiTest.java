...
//basically this is a copy o Local Test, but has some
//small differences - in some cases the timeout must be
//customised, because gae seems to be very slow after 
//deploy
public class RemoteClientApiTest {

	private final String TEST_URL = "http....";
	private final static String CONFIG_URL = "http....";
	private final static String DEL_CONFIG_URL = "http....";
